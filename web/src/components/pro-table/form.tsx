...
function SearchForm(props: {
  ...
  const {
    initialValues = {},
    formOptions = [],
    createdTimeText = locale['table.setting.form.ctime.label'],
  } = props
  const handleSubmit = () => {
  ...
  return (
    <div className={styles['search-form-wrapper']}>
                ...
                >
                  <Form.Item label={item.label} name={item.fieldName}>
                    <Input
                      ...
                      placeholder={
                        !item.placeholder
                          ? `${locale['table.setting.form.input.placeholder']}${item.label}`
                          : item.placeholder
                      }
                    />
                  </Form.Item>
                ...
                >
                  <Form.Item label={item.label} name={item.fieldName}>
                    <Select
                      placeholder={
                        !item.placeholder
                          ? `${locale['table.setting.form.select.placeholder']}${item.label}`
                          : item.placeholder
                      }
      ...
      >
        ...
        >
          {locale['table.setting.form.search.label']}
        </Button>
        <Button
          loading={props.loading}
          icon={<ReloadOutlined />}
          onClick={handleReset}
        >
          {locale['table.setting.form.reset.label']}
        </Button>
      </Space>
    </div>
  )
